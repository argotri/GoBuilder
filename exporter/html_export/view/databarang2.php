	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row col-lg-12" id="home">
                ...
                <a href="<?php echo $this->renderUrl("DataBarang2","tambah"); ?>" class="btn btn-success btn-outline"><i class="fa fa-plus"></i> Tambah</a>
...
<td>Jumlah</td>
                        ...
                        <?php foreach($db as $v){ ?>
                          <tr>
                            ...
                            <td ><?php echo $v["id"] ?></td>
<td ><?php echo $v["namabarang1"] ?></td>
<td ><?php echo $v["jumlah2"] ?></td>

                            <td ><a href="<?php echo $this->renderUrl("DataBarang2","edit",$v['id']); ?>"><i class="fa fa-pencil"></i></a>&nbsp; &nbsp;<a href="<?php echo $this->renderUrl("DataBarang2","delete",$v['id']) ?>"> <i class="fa fa-times"></i></a></td>
                          </tr>
                          <?php }; ?>
                        </tbody>
                    </table>
