	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row col-lg-12" id="home">
                ...
                <form method="post" action="<?php echo $this->renderUrl("DataBarang2","edit_data"); ?>">
               

				<div class="form-group">
				<label>Nama Barang</label>
				<input type="text" class="form-control" required='required' name="namabarang1" value="<?php echo $e[0]["namabarang1"] ?>">
				...
				<div class="form-group">
				<label>Jumlah</label>
				<input type="number" class="form-control" required='required' name="jumlah2" value="<?php echo $e[0]["jumlah2"] ?>">
				<p class="help-block"></p>
				</div>
